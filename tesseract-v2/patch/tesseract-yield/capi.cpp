...
TESS_API char* TESS_CALL TessBaseAPIGetUTF8Text(TessBaseAPI* handle, void (*_PA_YieldAbsolute)(void), size_t interval)
{
    return handle->GetUTF8Text(_PA_YieldAbsolute, interval);
}
